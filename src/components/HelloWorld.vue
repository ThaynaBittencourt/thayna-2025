...
<template>
  ...
  <!-- rede sociais -->
  <div
    class="card fixed top-[20%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex gap-4 z-20"
  >
    <a href="https://www.instagram.com/negrescooficial/">
  ...
  <div class="absolute top-200 left-1/2 transform -translate-x-1/2 z-20" style="
    display: flex;
    ...
    <div>
      <p class="text-[#26765f] text-md font-bold">
        ...
        <p class="text-[#26765f] text-md font-bold mb-5 mt-5">Minha especialização é em desenvolvimento Full-Stack, trabalhando com diversas
        bibliotecas, frameworks e ferramentas modernas. Tenho experiência sólida
        em Front-End: HTML, CSS, JavaScript, Vue.js, Tailwind, Bootstrap, Bulma,
        e em Back-End: PHP com Laravel, integração com bancos de dados como
        MySQL e PostgreSQL, utilizando ferramentas como HeidiSQL. Também aplico
        meus conhecimentos em automações com n8n.</p>
        <p class="text-[#26765f] text-md font-bold">
Além disso, sou designer e
        aplico técnicas de criação em Photoshop, CorelDRAW, Figma e Canva,
        desenvolvendo imagens bem atrativas. Sou apaixonada por unir tecnologia
        e design, entregando soluções completas, inovadoras, responsivas e com
